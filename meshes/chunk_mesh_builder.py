...
from utils import can_bcm_block, is_transparent
...
def is_void(voxel_pos, world_pos, world_voxels):
    ...
    if is_transparent(chunk_voxels[voxel_index]):
        return True
    return False
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if not voxel_id or not can_bcm_block(voxel_id): continue
                #voxel world pos
    ...
    for x in range(CHUNK_SIZE):
        for y in range(CHUNK_SIZE):
            for z in range(CHUNK_SIZE):
                ...
                if voxel_id == GLASS:
                    #top
                    v0 = to_float32(x + 0.4 , y + 0.8, z + 0.4   , GLASS_SIDE, 0, 0)
                    v1 = to_float32(x + 0.55, y + 0.8, z + 0.4  , GLASS_SIDE, 1, 0)
                    v2 = to_float32(x + 0.55, y + 0.8, z + 0.55, GLASS_SIDE, 1, 1)
                    v3 = to_float32(x + 0.4, y + 0.8, z + 0.55, GLASS_SIDE, 0, 1)

                    index = add_data(vertex_data, index, v0, v3, v2, v0, v2, v1)

                # right
              
                    v0 = to_float32(x + 0.55, y    , z  + 0.4 , GLASS_SIDE, 1, 1)
                    v1 = to_float32(x + 0.55, y + 0.8, z  + 0.4, GLASS_SIDE, 1, 0)
                    v2 = to_float32(x + 0.55, y + 0.8, z + 0.55, GLASS_SIDE, 0, 0)
                    v3 = to_float32(x + 0.55, y    , z + 0.55, GLASS_SIDE, 0, 1)

                    index = add_data(vertex_data, index, v0, v1, v2, v0, v2, v3)

                # left
             
                    v0 =  to_float32(x + 0.4, y    , z + 0.4, GLASS_SIDE, 1, 1)
                    v1 =  to_float32(x + 0.4, y + 0.8, z + 0.4, GLASS_SIDE, 1, 0)
                    v2 =  to_float32(x + 0.4, y + 0.8, z + 0.55, GLASS_SIDE, 0, 0)
                    v3 =  to_float32(x + 0.4, y    , z + 0.55, GLASS_SIDE, 0, 1)

                    index = add_data(vertex_data, index, v0, v2, v1, v0, v3, v2)

                # back 
            
                    v0 = to_float32(x + 0.4,y,     z + 0.4, GLASS_SIDE, 0, 1)
                    v1 = to_float32(x + 0.4,y + 0.8, z + 0.4, GLASS_SIDE, 0, 0)
                    v2 = to_float32(x + 0.55, y + 0.8, z + 0.4, GLASS_SIDE, 1, 0)
                    v3 = to_float32(x + 0.55, y,     z + 0.4, GLASS_SIDE, 1, 1)

                    index = add_data(vertex_data, index, v0, v1, v2, v0, v2, v3)

                # front
                    v0 = to_float32(x + 0.4, y    , z + 0.55, GLASS_SIDE, 0, 1)
                    v1 = to_float32(x + 0.4, y + 0.8, z + 0.55, GLASS_SIDE, 0, 0)
                    v2 = to_float32(x + 0.55, y + 0.8, z + 0.55, GLASS_SIDE, 1, 0)
                    v3 = to_float32(x + 0.55, y    , z + 0.55, GLASS_SIDE, 1, 1)
